...
| **Pause programmée** | Suspend les programmes automatiques pour une durée réglable (1 à 14 jours), avec **vérification réelle** que le boîtier a bien pris en compte la pause (pas juste une supposition côté ESPHome) |
